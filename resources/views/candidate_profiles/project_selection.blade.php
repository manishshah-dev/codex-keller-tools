<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Select Project for Profiles') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4">{{ __('Your Projects') }}</h3>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        {{ __('You don\'t have any projects yet.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                                    <div class="p-5">
                                        ...
                                        <div class="flex items-center text-sm text-gray-500 mb-4">
                                            ...
                                            <span>{{ $project->candidates->count() }} candidates</span>
                                        </div>
                                        
                                        <div class="mt-4">
                                            <a href="{{ route('projects.profiles.index', $project) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                                {{ __('View Profiles') }}
                                            </a>
                                        </div>
                                    </div>
